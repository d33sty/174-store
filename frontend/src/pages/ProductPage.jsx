              ...
              return (
                <div className="flex flex-col border-b md:border-b-0 md:border-r border-gray-100">
                  <div className="aspect-square bg-gray-50 flex items-center justify-center relative overflow-hidden">
                    {currentUrl ? (
                      <>
                        <img src={`/api${currentUrl}`} aria-hidden="true" className="absolute inset-0 w-full h-full object-cover scale-110 blur-xl opacity-60" />
                        <img src={`/api${currentUrl}`} alt={product.name} className="relative w-full h-full object-contain z-10" />
                      </>
                    ) : (
